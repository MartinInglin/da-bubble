...
@Component({
  selector: 'app-add-user-to-channel-mobile',
  standalone: true,
  imports: [
    CommonModule,
    MatCardModule,
  ...
  templateUrl: './add-user-to-channel-mobile.component.html',
  styleUrl: './add-user-to-channel-mobile.component.scss'
})
export class AddUserToChannelMobileComponent implements OnInit, OnDestroy {
  users: User[] = [];
  ...
  constructor(
    public dialogRef: MatDialogRef<AddUserToChannelMobileComponent>,
